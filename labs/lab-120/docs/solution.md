...
## Step 1: Check the default zone and active zones
...
## Step 2: Assign the interface to the public zone (if needed)

```bash
sudo firewall-cmd --zone=public --change-interface=enp0s1 --permanent
...
## Step 3: Permanently allow the https service
...
## Step 4: Permanently allow the custom port 8443/tcp
...
## Step 5: Apply the permanent configuration to the runtime
...
## Step 6: Confirm runtime and permanent configuration now agree
