# section-010 / module-01: IPv4 & IPv6 Interface Configuration (Guided Practice)
...
```bash
astrona run --git git@github.com:astrona-io/ATS003.git -c labs/section-010/module-01/lab-01
```

## Learning Path & Objectives
This training sandbox maps directly to the step-by-step guided instructions inside:
**[Section 010, Module 01](../../../sections/section-010/module-01/course.md)**
