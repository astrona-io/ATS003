...
| [lab-060](labs/lab-060) | Static Routing Across Multiple Interfaces | 1 | `astrona run --git git@github.com:astrona-io/ATS003.git -c labs/lab-060` |
...
| [lab-110](labs/lab-110) | DNS Verification with dig | 1 | `astrona run --git git@github.com:astrona-io/ATS003.git -c labs/lab-110` |
