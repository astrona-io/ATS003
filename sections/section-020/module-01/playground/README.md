# Link Aggregation with Linux Bonding — Playground

- **ID:** PLAYGROUND
- **Slug:** linux-bonding-playground
- **Author:** Paris Nakita Kejser
- **Type:** Astrona playground — clean environment, no task, no grading

Clean Linux host with multiple NICs for exploring bonding modes, miimon, and /proc/net/bonding.
...
`astrona destroy` takes the environment name (`metadata.name` = `linux-bonding-playground`), not
