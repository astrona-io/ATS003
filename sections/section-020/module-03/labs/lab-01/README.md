# section-020 / module-03: Multi-Interface Static Routing (Guided Practice)
...
```bash
astrona run --git git@github.com:astrona-io/ATS003.git -c labs/section-020/module-03/lab-01
```

## Learning Path & Objectives
This training sandbox maps directly to the step-by-step guided instructions inside:
**[Section 020, Module 03](../../../sections/section-020/module-03/course.md)**
