# section-060 / module-03: Active Socket Diagnostics (ss) (Guided Practice)
...
```bash
astrona run --git git@github.com:astrona-io/ATS003.git -c sections/section-060/module-03/labs/lab-01
```

## Learning Path & Objectives
This training sandbox maps directly to the step-by-step guided instructions inside:
**[Section 060, Module 03](../../course.md)**
