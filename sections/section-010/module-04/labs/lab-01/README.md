# section-010 / module-04: Local Hostname Name Resolution (Guided Practice)
...
```bash
astrona run --git git@github.com:astrona-io/ATS003.git -c labs/section-010/module-04/lab-01
```

## Learning Path & Objectives
This training sandbox maps directly to the step-by-step guided instructions inside:
**[Section 010, Module 04](../../../sections/section-010/module-04/course.md)**
