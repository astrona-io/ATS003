# section-010 / capstone: Core Host Configurations Capstone
...
```bash
astrona run --git git@github.com:astrona-io/ATS003.git -c sections/section-010/capstone/labs/lab-01
```
