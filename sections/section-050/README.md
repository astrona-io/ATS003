...
*   **Hands-on Training Lab 1 (Nginx Proxy):** **[section-050/module-01](module-01/labs/lab-01)** (astrona command: "astrona run --git git@github.com:astrona-io/ATS003.git -c sections/section-050/module-01/labs/lab-01")
*   **Hands-on Training Lab 2 (Nginx LB):** **[section-050/module-02](module-02/labs/lab-01)** (astrona command: "astrona run --git git@github.com:astrona-io/ATS003.git -c sections/section-050/module-02/labs/lab-01")
*   **Hands-on Training Lab 3 (SSH Hardening):** **[section-050/module-03](module-03/labs/lab-01)** (astrona command: "astrona run --git git@github.com:astrona-io/ATS003.git -c sections/section-050/module-03/labs/lab-01")

### 3. Unguided Challenge Lab
*   **Hands-on Challenge Lab (Capstone):** **[section-050/capstone](capstone/labs/lab-01)** (astrona command: "astrona run --git git@github.com:astrona-io/ATS003.git -c sections/section-050/capstone/labs/lab-01")
