# section-050 / module-02: Nginx Upstream Load Balancers (Guided Practice)
...
```bash
astrona run --git git@github.com:astrona-io/ATS003.git -c labs/section-050/module-02/lab-01
```

## Learning Path & Objectives
This training sandbox maps directly to the step-by-step guided instructions inside:
**[Section 050, Module 02](../../../sections/section-050/module-02/course.md)**
