# section-030 / module-01: Packet Filtering with nftables (Guided Practice)
...
```bash
astrona run --git git@github.com:astrona-io/ATS003.git -c labs/section-030/module-01/lab-01
```

## Learning Path & Objectives
This training sandbox maps directly to the step-by-step guided instructions inside:
**[Section 030, Module 01](../../../sections/section-030/module-01/course.md)**
