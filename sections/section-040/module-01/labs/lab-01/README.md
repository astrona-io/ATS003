# section-040 / module-01: NTP Client Time Synchronization (Guided Practice)
...
```bash
astrona run --git git@github.com:astrona-io/ATS003.git -c sections/section-040/module-01/labs/lab-01
```

## Learning Path & Objectives
This training sandbox maps directly to the step-by-step guided instructions inside:
**[Section 040, Module 01](../../course.md)**
