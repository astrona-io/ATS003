# section-040 / module-03: DNS Verification with dig (Guided Practice)
...
```bash
astrona run --git git@github.com:astrona-io/ATS003.git -c sections/section-040/module-03/labs/lab-01
```

## Learning Path & Objectives
This training sandbox maps directly to the step-by-step guided instructions inside:
**[Section 040, Module 03](../../course.md)**
